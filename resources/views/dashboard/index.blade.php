        ...
        <div class="panel-card-table">
            ...
            @else
                <div class="table-control-bar">
                    ...
                    <button class="export-btn" onclick="window.location.href='{{ request()->fullUrlWithQuery(['force_sync' => 1]) }}'" style="margin-left: 8px; background-color: #008060; color: white; border: none;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 4px;"><path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38l5.67-5.67"/></svg>
                        <span>Sync Shopify Data</span>
                    </button>
                </div>
