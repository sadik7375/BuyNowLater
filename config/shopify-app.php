...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,read_draft_orders,write_draft_orders,read_orders,read_all_orders,read_customers'),
